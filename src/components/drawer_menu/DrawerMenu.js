...
import {Toolbar,CssBaseline, ListItem,MenuItem,ListItemButton,IconButton,Divider,Typography
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Restart Dana', 'Stop Dana', 'Settings', 'Backup'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                >
                  {index % 2 === 0 ?  <RestartAltIcon />:<HighlightOffIcon  />}                  
                </ListItemIcon>
